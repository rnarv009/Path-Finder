...
GOOGLE_MAPS_API_KEY = "AIzaSyAEKuzQ0ScPg1MW6n0KSxkOrJEVhsJ-JOI"
waypoints_file = "my-waypoints-dist-dur1.tsv"
...
all_waypoints = ["Mehrangarh Fort, Jodhpur, Rajasthan, India",
                 "Taj Mahal, Agra, Uttar Pradesh, India",
                 "Khajuraho Temples, Khajuraho, Madhya Pradesh, India",
                 "Amer Fort and Palace, Jaipur, Rajasthan, India",
                 "Itmad-ud-Daula, Agra, Uttar Pradesh, India",
                 "Maharajah's Palace, Mysore, Karnataka, India",
                 "Swaminarayan Akshardham, New Delhi, Delhi, India",
                 "Agra Fort, Agra, Uttar Pradesh, India",
                 "Humayun's Tomb, New Delhi, Delhi, India",
                 "Qutub Minar, New Delhi, Delhi, India",
                 "Mani Bhavan Gandhi Sanghralaya, Laburnum Road, Papanas Wadi, Mumbai, Maharashtra, India",
                 "Jaisalmer Fort, Amar Sagar Pol, Jaisalmer, Rajasthan, India",
                 "Golconda Fort, Fort Road, Hyderabad, Telangana, India",
                 "Gandhi Smriti, New Delhi, Delhi, India",
                 "Palace Of Maharana Pratap, Udaipur, Rajasthan, India",
                 "India Backwaters, Kochi, Kerala, India",
                 "Golden Temple, Amritsar, Punjab, India",
                 "Ajanta Caves, Aurangabad, Maharashtra, India",
                 "Gateway Of India Mumbai, Mumbai, Maharashtra, India",
                 "Virupaksha Temple, Hampi, Karnataka, India",
                 "Palolem Beach, Goa, India",
                 "Kanha National Park, Madhya Pradesh, India",
                 "Ganges, Katesar, Varanasi, Uttar Pradesh, India",
                 "Dal Lake, Rainawari, Srinagar",
                 "Jog Falls, Karnataka, India",
                 "Hawa Mahal, Hawa Mahal Road, Badi Choupad, Pink City, Jaipur, Rajasthan, India",
                 "Marine Drive, Chowpatty, Mumbai, Maharashtra, India",
                 "Red Fort, Netaji Subhash Marg, Chandni Chowk, New Delhi, Delhi, India",
                 "Charminar, Hyderabad, Telangana, India",
                 "Kodaikanal Lake, Kodaikanal, Tamil Nadu, India",
                 "Darjeeling Rangeet Valley Passenger Ropeway, Darjeeling, West Bengal, India",
                 ...
                 "Solang Valley, Burwa, Himachal Pradesh, India" ]
...
if __name__ == '__main__':
    ...
    if os.path.exists('C://Users/rahul/PycharmProjects/India_tour/my-waypoints-dist-dur1.tsv'):
        ...
        waypoint_data = pd.read_csv('C://Users/rahul/PycharmProjects/India_tour/my-waypoints-dist-dur1.tsv', sep="\t")
        ...
        gmaps = googlemaps.Client(GOOGLE_MAPS_API_KEY,requests_kwargs={'proxies':{"http":"http://ipg_2014064:rahul8764050833@192.68.1.107:3128","https":"http://ipg_2014064:rahul8764050833@192.168.1.107:3128"}})
